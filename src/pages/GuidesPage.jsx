...
const GuidesPage = () => {
  const guidesCollectionStructuredData = {
    '@context': 'https://schema.org',
    '@type': 'CollectionPage',
    name: 'FreeAppKit Guides',
    url: 'https://freeappkit.com/guides',
    description:
      'Practical guides for productivity, health, finance, security, and sustainability tools.',
    hasPart: guideCatalog.map((guide) => ({
      '@type': 'Article',
      headline: guide.title,
      description: guide.metaDescription,
      url: `https://freeappkit.com/guides/${guide.slug}`,
    })),
  };
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white flex flex-col">
      <SeoHead
        ...
        path="/guides"
        keywords="how-to guides,productivity guide,finance calculator guide,password guide,bmi guide,compound interest guide,carbon footprint guide,freeappkit guides"
        structuredData={guidesCollectionStructuredData}
